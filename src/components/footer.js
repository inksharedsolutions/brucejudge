            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Bruce Judge loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/Bruce-Judge-2122693281108172/?ref=bookmarks"
                                        target="_blank"
                                        rel="noreferrer">
                                        <FontAwesomeIcon
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/43699398-in-fellowship-with-god"
                                        rel="noreferrer"
                                    >
